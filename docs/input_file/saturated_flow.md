...
<u><u>Explanation:</u> &nbsp;</u> &nbsp;  This keyword is used to set a constant Darcy
...
<u><u>Explanation:</u> &nbsp;</u> &nbsp;  This keyword is used to set a constant gas
flux. As a vector, it includes X, Y, and Z components. In a
one-dimensional problem in X, the Y and Z velocities are optional. Units
are changed inside the FLOW block with the *space_units* and
*time_units* keywords.
...
<u><u>Explanation:</u> &nbsp;</u> &nbsp;  This keyword beginning with *pump* sets a
...
injection well (in the case of pumping or withdrawal, the downstream conditions 
are irrelevant).
...
<u><u>Explanation:</u> &nbsp;</u> &nbsp;  This keyword beginning with *gaspump* sets a
...
<u>Explanation:</u> &nbsp;  This keyword specifies an infiltration rate
...
<u>Backwards compatible:</u> &nbsp; read_velocity

<u>Default:</u> &nbsp; None

<u>Explanation:</u> &nbsp;  This keyword provides a filename prefix for
...
using the SingleColumn format. Units are set with
...
interface between grid cell 2 and 3. Accordingly, the first
...
<u>Backwards compatible:</u> &nbsp; read_gasvelocity
...
using the ContinuousRead format. Units are set with
...
read:
    ...
    READ(53,*) ( ((qygas(jx,jy,jz), jx=1,nx), jy=0,ny), jz=1,nz )
    READ(54,*) ( ((qzgas(jx,jy,jz), jx=1,nx), jy=1,ny), jz=0,nz )
...
<u>Explanation:</u> &nbsp;  This keyword indicates whether flow will be
...
<u>Backwards compatible:</u> &nbsp; read_permeability
...
using the *SingleColumn* format. Units of the permeability are $m^2$.
...
or
    ...
    Syntax:  permeability_x  value  default

<u>Default:</u> &nbsp; None

<u>Explanation:</u> &nbsp;  The *permeability_x* keyword uses an input
...
or
    ...
    Syntax:  permeability_y  value  default

<u>Default:</u> &nbsp; None

<u>Explanation:</u> &nbsp;  The *permeability_y* keyword uses an input
format similar to other parameters specified by zone (e.g., pressure,
...
or
    ...
    Syntax:  permeability_z  value  default

<u>Default:</u> &nbsp; None

<u>Explanation:</u> &nbsp;  The *permeability_z* keyword uses an input
format similar to other parameters specified by zone (e.g., pressure,
tortuosity). See the keyword *permeability_x* for details on how this
keyword is used to specify permeabilities by zone. The convention
adopted here is that all three dimensions must be specified, even in a
...
<u>Default:</u> &nbsp; 90° to all vector directions

<u>Explanation:</u> &nbsp;  This keyword provides the angle relative to
...
Keyword used to specify the fluid pressure by zone in the input file.
    ...
    Syntax:  pressure  value  zone  jxbegin-jxend  ybegin-jyend  jzbegin-jzend  fix

or

    Syntax:  pressure  value  default

<u>Default:</u> &nbsp; None

<u>Explanation:</u> &nbsp;  The *pressure* keyword uses an input format
...
<u><u>Explanation:</u> &nbsp;</u> The keyword parameter
